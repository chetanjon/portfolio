...
const previewStudies: PreviewStudy[] = [
  {
    ...
    headline: 'Launched at a 5.0 rating after a research-led V2 rewrite',
    problem: 'A 3-person team, a SwiftUI / SwiftData / WidgetKit / FamilyControls stack, and a procrastination app positioned against the "discipline" frame every competitor assumes.',
    metric: { value: 5, decimals: 1, suffix: '★' },
    metricLabel: 'App Store launch rating · 25-user closed beta',
    accent: '#5B4EB8',
    tag: 'Shipped',
  },
  {

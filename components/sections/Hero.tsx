    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="font-display font-black uppercase tracking-tight text-5xl sm:text-7xl md:text-8xl lg:text-[7.5rem] xl:text-[8.5rem] gradient-text-cycle leading-[0.9]">
            ship it end to end.
          </span>
        </motion.div>
